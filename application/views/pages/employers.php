...
<div class="container-fluid">
	<div class="row jumbotron">
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
			<p class="lead">Welcome to the employers site. If you want to become an employer register below, or if you already have a profile, log in. Below you can discover potetial actors. To browse throught potetntial employees, you need to have a profile.</p>
		</div>
