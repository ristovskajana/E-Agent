...
<div class="row">
	<div class="col">
		...
		<div class="col">
			<h2 class="text-info" style="color: #a80808;">Your Pictures</h2>
			<div class="row">			
	...
	<?php else: ?>
		<div class="alert alert-primary" role="alert">
			You currently don't have Portfolio Pictures!
		</div>
	<?php endif; ?>
</div>
<hr>
<div class="col">
	<div class="col">
		<div class="block-heading" align="center">
			<h2 class="text-info" style="color: #a80808;">Upload Portfolio Pictures</h2>
	...
	<div class="form-group"><label for="PPicture">Title</label>
		<?php
		$data2 = array(
			'type' => 'text',
			'name' => 'PPicture',
...
<div class="col">
	...
	<div class="form-group"><label for="IType">Type of information (ex. Height, Nationality..)</label>
		<br/>
		<?php
		$data3 = array(
			'type' => 'text',
